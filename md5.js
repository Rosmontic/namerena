...
u.r.db = 900
r.push(T.e("[1]：大！酱！", n.r, u.r.db, m, m, 0, 1000, 100))
r.push(T.e(O.c("YmSv"), n.r, T.a1(u, 0), new T.aG(t), m, 0, 1000, 100))
r.push(T.e("[0][2]：i！d！", this.id, this.ci.id.length, m, m, 0, 1000, 100))
...
C.cirno = H.a(u([0, 12, 0, 0, 0, 0, 0, -220]), [P.j])
