...
T.tha4s1.prototype = {
        ...
        t: function(a, b, c, d) {
            var u, t, s, r, q, p, o, n = this, m = null,v= n.fr
            n.f = C.b.v(n.f + 1, 2)
            u = a[0].a
            t = C.e.Z(T.u(n.r, !0, c) / 75)
            s = u.fx
            if (s = u.fx)
                t = s
            r = d.a
            r.push(T.e("[0]使用捏造「科廷利的花仙子」", n.r, u, m, m, 1, 1000, 100))
            r.push(T.e(C.c.K(O.c("ldpQ"), $.lb()), n.r, u, m, m, t + 60, 1000, 100))
            u.fr = t
            q = u.x
            if (!C.a.w(q.f, u)) {
...
T.i9m.prototype = {
    ...
    (function inheritance() {
        ...
        s(T.cA, [T.eY, T.eZ, T.f_, T.f0, T.d7, T.d8, T.f1, T.f2, T.bA, T.f4, T.f6, T.tigershark, T.dark, T.hell, T.yuri2, T.yuriy, T.megia, T.testa, T.daiyousei, T.cirno])
        t(T.hg, T.cy)
        t(T.f3, T.bA)
...
C.daiyousei = H.a(u([0, 12, 26, 1, 0, 15, 25, 152]), [P.j])
C.cirno = H.a(u([0, 12, 0, 0, 0, 0, 0, 600]), [P.j])
