...
n.r.bf(n.r.fr, null, c, d)
	...
	T.yeye.prototype = {
        t: function(a, b, c, d) {
			...
			if( v ==6 ){
            o.push(T.e("[0]: 记忆 记忆最多掌 ", r.r, p, q, q, 0, 1000, 100))}
			if( v ==7 ){
