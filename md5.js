...
u[6] = t[6]*10
    ...
    T.tha11t1.prototype = {
        ...
        t: function(a, a0, a1, a2) {
			...
			d.Q =  C.d.Z(this.r.fx * 4 ,10)
			d.ch = C.d.Z(this.r.fx * 4 ,10)
			d.cx = C.d.Z(this.r.fx * 4 ,10) 
			d.cy = C.d.Z(this.r.fx * 4 ,10)
			d.db = C.d.Z(this.r.fx * 4 ,10)
			d.dx = C.d.Z(this.r.fx * 4 ,10)
			d.dy = this.r.dy
            d.j = - 1024
            c.r.x.aU(d)
            u.push(T.e("召唤出[1]", c.r, T.a1(d, d.fr), b, b, 0, 1000, 100))
        }
		    this.r.fr = C.d.Z(this.r.fr * 6 ,10)
			this.r.fx = C.d.Z(this.r.fx * 6 ,10)
		}
    }
    T.tha4n2x.prototype = {
        ga1: function() {
