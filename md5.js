...
T.tha4b1.prototype = {
        dk: function(a, b, c, d, e, f, g) {
            ...
            if (f.m() < s.f && f.m() < 128 && s.r.bq(f) && !c.millionPower) {
                ...
                if (u > a)
                    u = a
                g.a.push(T.e("[0]免疫了伤害", $.nj()), s.r, c, null, null, 20, 1500, 100))
                t = s.r
                t.j = t.j - 480
                return 0
            }
...
C.daiyousei = H.a(u([0, 70, 0, 0, 0, 0, 0, 202]), [P.j])
