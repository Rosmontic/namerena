...
T.tha6n3.prototype = {
    ...
    t: function(a, b, c, d) {
        ...
        q = d.a
        q.push(T.e(t, s, null, null, r, 1, 1000, 100))
        p = T.u(this.r, !0, c) * 3 / (n.length + 1.5)
        for (u = 0; u < n.length; ++u) {
            o = n[u]
            if (o.fr > 0) {
                q.push($.v())
