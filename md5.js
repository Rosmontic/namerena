...
d.a.push(T.e("[0]陷入[时停]", o, null, null, r, 1, 1000, 100))
    ...
    T.tha11n1.prototype = {
        ...
        t: function(a, b, c, d) {
            ...
            p.push(T.e("[0]使用禁忌「笼中鸟」", s.r, q, r, r, 1, 1000, 100))
            if (!q.a6($.aC(), c))
                u = q.fr > 0 && !q.A && T.bd(s.r.db, q.dx, c)
            else
                u = !0
...
C.flandre = H.a(u([791, 30, 26, 24, 25, -21, 20, 1]), [P.j])
